<div style="padding:20px">
    ...
    <div class="row m-0">
        ...
        @endphp
        <div class="col-md-3 p-0 mt-2" style="background-color: #f2f2f2;margin-right:5px;">
    ...
    <div class="row">
        <div class="col-md-3 rounded mt-3" style="background-color:#f2f2f2; padding: 5px; max-height:300px;overflow-y:auto">
