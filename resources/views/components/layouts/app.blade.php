...
<body>
    ...
    <div class="container-fluid">
        <div class="col-md-2">
            <img src="{{ asset('public/images/logonobg.png') }}" style="width: 200px; height: 50px; margin: 8px auto;" alt="">
            <a class="menu-link @if(request()->is('/')) active @endif" href="/"><i class="fas fa-mobile-alt"></i><span class="icon-text"> Customers</span></a><br>
            ...
            <a class="menu-link @if(request()->is('employees')) active @endif" href="#"><i class="fas fa-users"></i><span class="icon-text"> Employees</span></a><br>
            ...
            <a class="menu-link @if(request()->is('invoice')) active @endif" href="#"><i class="fas fa-receipt"></i><span class="icon-text"> Invoice</span></a>
