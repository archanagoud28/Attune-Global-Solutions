...
class HrLogin extends Component
{
    ...
    public function empLogin()
    {
        try {
            ...
            if (
                Auth::guard('hr')->attempt(['email' => $this->form['id'], 'password' => $this->form['password']]) ||
                ...
                Auth::guard('employee')->attempt(['email' => $this->form['id'], 'password' => $this->form['password']]) ||
                ...
                Auth::guard('customer')->attempt(['email' => $this->form['id'], 'password' => $this->form['password']]) ||
                ...
                Auth::guard('vendor')->attempt(['email' => $this->form['id'], 'password' => $this->form['password']]) ||
                ...
                Auth::guard('contractor')->attempt(['contractor_email' => $this->form['id'], 'password' => $this->form['password']]) ||
